...
{
  int unk_0;
  int numExportLibs; //number of sysmem's export libraries - set in SysMemInit
  void *exportLib[8]; //array of sysmem's export tables set in SysMemInit
  int loadcore_addr; //allocated in SysMemInit
  int userLibStart; //offset in export_lib at which user libraries begin - set in SysMemInit
  int unk_30;
  int unk_34;
  int unk_38;
  int unk_3C;
